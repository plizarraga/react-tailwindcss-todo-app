...
const TodoCreate = ({ createTodo }) => {
  ...
  return (
    ...
    >
      ...
      <input
        type="text"
        className="w-full text-gray-500 outline-none transition-all duration-700 placeholder:text-gray-400 dark:bg-slate-800 dark:text-slate-500 dark:placeholder:text-slate-500"
